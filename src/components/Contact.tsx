      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-xl">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-6">
            Let&apos;s build
            <br />
            <span className="text-[#D21404]">something useful.</span>
          </h2>
          ...
          <div className="flex flex-col gap-3">
            {socials.map((s) => (
              ...
              >
                <span className="w-9 h-9 rounded-xl bg-white/5 border border-white/8 flex items-center justify-center font-mono text-xs text-white/40 group-hover:text-[#D21404] group-hover:border-[#D21404]/30 transition-all">
                  {s.icon}
                </span>
                <span className="text-sm text-white/50 group-hover:text-white transition-colors">
                  {s.label}
                </span>
                <span className="ml-auto text-white/20 group-hover:text-[#D21404] transition-colors">
                  →
                </span>
              </a>
            ))}
